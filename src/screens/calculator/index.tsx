                ...
                <View>
                    {calculatedWater > 0 && (
                        <View style={styles.recommendationContainer}>
                            <Text style={styles.recommendationText}>Recommended water per day is <Text style={styles.boldText}>{calculatedWater}ml</Text></Text>
                            <Text style={styles.recommendationText}>Press the Apply button to set it as daily amount</Text>
                            <Button style={styles.applyButton} mode="contained" onPress={() => onApplyPressed(calculatedWater)}>
                                Apply
                            </Button>
                        </View>
                    )}
